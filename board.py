...
class Board:
    ...
    def __init__(self):
        ...
        self._square[6] = 'n'
        self._square[7] = 'r'
        self._square[len(self._square) - 1] = 'R'
        self._square[len(self._square) - 2] = 'N'
        self._square[len(self._square) - 3] = 'B'
        self._square[len(self._square) - 4] = 'Q'
        self._square[len(self._square) - 5] = 'K'
        self._square[len(self._square) - 6] = 'B'
        self._square[len(self._square) - 7] = 'N'
        self._square[len(self._square) - 8] = 'R'
